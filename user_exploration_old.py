...
# [1] threshold irrelevant columns - i.e. < 0.5 for any given song 
# [2] split up by genre vs musicality 
# [3] .... what the heck do I want to do with this lol 

# what would be nice for the tSNE to show? 
# what is the "story"?

# we want to understand our own music preferences compared to our friends'
# and find things that you might like in a coffee shop playlist
# or a friend